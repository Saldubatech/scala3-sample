// Taken from https://github.com/LucaCanali/Miscellaneous/blob/master/Spark_Notes/Spark_Histograms/scala/src/main/scala/ch/cern/sparkhistogram/histogram.scala
